...
<pre class="sh_html">
  curl -i -H "Accept: application/json" -X POST -d "event_id=1840479691&guest[first]=test&guest[last]=test&guest[phone]=5555555&guest[email]=test@test.com" "http://localhost:3000/api/guests?username=venuesite&password=password"
</pre>
<br/>
