...
h1. Get a Table list for a Venue and an Area
...
<pre class="sh_html">
curl 'http://venuedriver.com/api/venues/1234/areas/777/tables.xml?username=venuesite&password=password'
</pre>
<br/>
...
<pre class="sh_html">
curl 'http://venuedriver.com/api/venues/1234/areas/777/tables.json?username=venuesite&password=password'
</pre>